...
USER_HISTORY_PATH = os.path.join(DATA_DIR, "historico_vini.csv")
CLUBS_DATA_PATH = os.path.join(DATA_DIR, "clubes.json")
TIME_IA_34_PATH = os.path.join(DATA_DIR, "time_ianova_rodada_34.csv") # Caminho do arquivo salvo
...
def gerar_dados_comparativos(ano=2025):
    """
    Gera o DataFrame consolidado para o gráfico comparativo com MÚLTIPLOS MODELOS.
    """
    print("--- DEBUG: Iniciando gerar_dados_comparativos (VERSÃO 1.8) ---")
