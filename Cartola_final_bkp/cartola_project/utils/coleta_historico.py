...
HISTORICAL_DATA_PATH = os.path.join(DATA_DIR, "historico_2025.csv")
...
def coletar_dados_historicos(ano, total_rodadas=38, rodada_especifica=None):
    ...
    if rodada_especifica and os.path.exists(HISTORICAL_DATA_PATH):
        ...
        # (Caso o usuário rode 2x a atualização da mesma rodada)
...
if __name__ == "__main__":
    ...
    coletar_dados_historicos(ano=2025, total_rodadas=34)
