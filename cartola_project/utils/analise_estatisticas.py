...
# --- CAMINHOS ---
HISTORICAL_MATCHES_PATH = config.HISTORICAL_MATCHES_PATH
HISTORICAL_PLAYERS_PATH = config.HISTORICAL_DATA_PATH
TEAM_STATS_PATH = config.ESTATISTICAS_TIMES_PATH
ODDS_PATH = config.ODDS_HISTORY_PATH
...
def analise_times(ano=config.CURRENT_YEAR, clubes_filtro=None):
    """
...
def analise_goleiros(ano=config.CURRENT_YEAR, clubes_filtro=None):
    """
...
def analise_atacantes(ano=config.CURRENT_YEAR, clubes_filtro=None):
    """
...
def analise_recorrencia(ano=config.CURRENT_YEAR, clubes_filtro=None, posicao_filtro=None):
    """
...
def analise_participacoes_detalhada(ano=config.CURRENT_YEAR, clubes_filtro=None, posicao_filtro=None, status_filtro=None, min_jogos=0):
    """
...
def analise_participacoes(ano=config.CURRENT_YEAR, clubes_filtro=None, posicao_filtro=None, status_filtro=None):
    """
...
def analise_combinada_cartola_fbref(ano=config.CURRENT_YEAR, clubes_filtro=None, posicao_filtro=None, status_filtro=None, min_jogos=0):
    """
    ...
    try:
        ...
        # Total de jogos = todas as rodadas onde apareceu (inclui pontuacao = 0)
